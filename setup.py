...
setup(
  ...
  download_url = 'https://github.com/estorrs/geoscatter/archive/0.3.tar.gz', # I'll explain this in a second
  keywords = ['map', 'plot', 'heatmap', 'points', 'scatter', 'figure', 'contour', 'density', 'geoscatter', 'gis'], # arbitrary keywords
  license='MIT',
  classifiers=[],
